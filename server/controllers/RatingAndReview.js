...
exports.getAllRatingReview = async (req, res) => {
  try {
    const allReviews = await RatingAndReview.find({})
      ...
      .populate({
        path: "user",
        select: "firstName lastName email imageUrl", // Specify the fields you want to populate from the "Profile" model
      })
      .populate({
        path: "course",
        select: "name", //Specify the fields you want to populate from the "Course" model
      })
      .exec();
...
exports.getAllCourseRating = async (req, res) => {
  try {
    ...
    const allRatingAndReview = await RatingAndReview.find({ course: courseId })
      .sort({ rating: "desc" })
      .populate({
        path: "user",
