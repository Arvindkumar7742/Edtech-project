...
function Home() {
  return (
    <div>
      {/*Section1  */}
      <div
        className="relative mx-auto mb-10 flex flex-col w-11/12 max-w-maxContent items-center 
    text-white justify-between bg-richblack-900"
      >
        ...
        <div className="text-[40px] text-white mt-6 text-bold">
          ...
          <span className="text-green-600 text-bold text-richblue-200">
            Coding Skills
          </span>
        </div>
        ...
        <div className="flex flex-row  gap-10 mt-[110px] ">
          ...
          <div
            className="text-white flex flex-row gap-2 border border-richblack-700 w-[400px] h-[235px] text-[14px]
         gradient-bg"
          >
            {/* code block */}
